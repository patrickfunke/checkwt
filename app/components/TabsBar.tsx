...
export default function TabsBar({ onTabSelected, tabsContent }: TabsBarProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      >
        <TabsList className="w-full max-w-[400px] rounded-full bg-gray-100 dark:bg-gray-800 m-4 p-1 flex gap-2 shadow-md">
          <TabsTrigger
            value="decode"
            onClick={() => handleTabChange("decode")}
            className="w-1/2 rounded-full py-2 text-base text-sm font-semibold transition-all touch-manipulation
